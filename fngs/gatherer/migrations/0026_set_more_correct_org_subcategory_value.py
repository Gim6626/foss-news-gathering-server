...
from gatherer.models import DigestRecordSubcategory, models
...
def migrate_to_new_org_subcategory(apps, schema_editor):
    ...
    for dr in dr_model.objects.all():
        if dr.subcategory == DigestRecordSubcategory.NEWS.name:
            dr.subcategory = DigestRecordSubcategory.ORG.name
            dr.save()
